...
const Tooltip: React.FC<ITooltip> = ({ onCancel, onAccept }) => (
  <div className={styles.Tooltip}>
    ...
    <div className={styles.Tooltip__buttons}>
      <Button className={classNames(styles.Tooltip__button, styles.Tooltip__buttonCancel)} onClick={onCancel}>
        No
      </Button>
      <Button className={classNames(styles.Tooltip__button, styles.Tooltip__buttonDelete)} onClick={onAccept}>
        Yes
      </Button>
    </div>
  </div>
